      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">{config.psychologist.name}</h3>
            <p className="text-gray-400 mb-4">{config.psychologist.title}</p>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Profesjonalne badania psychologiczne dla kierowców w Przemyślu. Zapewniamy wysoką jakość usług zgodnie z
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">{config.footer.copyright}</div>
